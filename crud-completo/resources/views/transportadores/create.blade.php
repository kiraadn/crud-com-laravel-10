...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-0">
        ...
        <h5 class="text-end">Ficha de Cadastro</h5>
    </div>
            ...
            <div class="col-12">
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <h4 class="pt-2 fw-1">Preencha os dados para registá-lo no sistema.</h4>
                        </div>
                    </div>
                    <!-- User id -->
                </div>
                ...
                <div class="view-dados-Pessoais-user mt-3">
                    <form class="row g-3 mt-3 needs-validation" novalidate method="post"
                        action="{{ route('transportadors.store') }}" enctype="multipart/form-data">
                        @csrf

                        <div class="col-sm-12 col-md-6 col-lg-7 mb-3">
                            <label for="nomeCompleto" class="form-label">Nome Completo</label>
                            <input type="text" class="form-control" placeholder="Nome Completo" id="nomeCompleto"
                        ...
                        <div class="col-sm-6 col-sm-4 col-md-4 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="telefone" name="telefone"
                                placeholder="(+258) Celular Opcional" required>
                            <div class="invalid-feedback fw-1">
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-8 mb-3 fw-1">
                            ...
                            <input type="text" class="form-control" id="morada" name="morada"
                                placeholder="Digite a localização do Transportador" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-sm-5 col-sm-4 col-md-6 col-lg-3 mb-3 fw-1">
                            ...
                            <input type="number" class="form-control" id="contaPagamento" name="contaPagamento"
                                placeholder="Digite o nº da conta " required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-sm-5 col-sm-4 col-md-6 col-lg-3 mb-3 fw-1">
                            ...
                            <input type="date" class="form-control" id="cartaValidade" name="cartaValidade" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-sm-3 col-sm-3 col-md-4 col-lg-4 ">
                            ...
                            <img src="" alt="" class="img-product" id="file-preview2" />
                            <input type="file" name="biFrontal" accept="image/*" onchange="showFile2(event)">
                        </div>

                        <div class="col-sm-3 col-sm-3 col-md-4 col-lg-4 ">
                            <label>BI Traseiro</label>
                            <img src="" alt="" class="img-product" id="file-preview3" />
                            <input type="file" name="biTraseira" accept="image/*" onchange="showFile3(event)">
                        </div>

                        <div class="col-sm-3 col-sm-3 col-md-4 col-lg-4 ">
                            <label>BI Traseiro</label>
                            <img src="" alt="" class="img-product" id="file-preview4" />
                            <input type="file" name="licensa" accept="image/*" onchange="showFile4(event)">
                        </div>



                        <div class="input-group pkl-input-group input-group-lg d-none" style="display: none;">
                            <input type="text" class="form-control" id="validationAge">
                        </div>

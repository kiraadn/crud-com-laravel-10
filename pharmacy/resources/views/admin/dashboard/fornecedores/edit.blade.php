                        ...
                        <form action="{{ route('fornecedores.update', [$fornecedor->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="has-validation col-sm-9">
                                    ...
                                    value="{{$fornecedor->suppliers_name}}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="has-validation col-sm-9">
                                    <input type="text" name="suppliers_company" class="form-control" id="suppliers_company" value="{{$fornecedor->suppliers_company}}" >
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="has-validation col-sm-9">
                                    <input type="email" name="suppliers_email" class="form-control" id="suppliers_email" value="{{$fornecedor->suppliers_email }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="has-validation col-sm-9">
                                    <input type="number" name="contact_number" class="form-control" id="contact_number" value="{{$fornecedor->contact_number }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="has-validation col-sm-9">
                                    <input type="number" name="celphone" class="form-control" id="celphone" value="{{$fornecedor->celphone }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="address" class="form-control" id="address" value="{{$fornecedor->address }}" required>
                                </div>
                            </div>
